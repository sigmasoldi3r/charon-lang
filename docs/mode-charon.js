...
(function (mod) {
  ...
  CodeMirror.defineMode("charon", function (options) {
    ...
    var coreSymbols = ["*", "**", "*'", "*1", "*2", "*3",
      ...
      "*math-context*", "module", "*out*", "*print-dup*", "*print-length*",
      ...
      "charon-version", "coll?", "comment", "commute", "comp", "comparator",
      ...
      "error-handler", "error-mode", "even?", "every-pred", "every?",
      "ex-data", "ex-info", "extend", "extend-protocol", "extend-type",
      "extenders", "extends?", "false?", "ffirst", "file-seq", "filter",
      "filterv", "find", "find-keyword", "find-ns", "find-protocol-impl",
      "find-protocol-method", "find-var", "first", "flatten", "float",
      "float-array", "float?", "floats", "flush", "fn", "fn!", "fn?",
      ...
      "refer", "refer-charon", "reify", "release-pending-sends", "rem",
    ...
    CodeMirror.registerHelper("hintWords", "charon",
  ...
  CodeMirror.defineMIME("text/x-charon", "charon");
